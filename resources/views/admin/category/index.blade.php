                        ...
                        <div class="modal-footer justify-content-center">
                            <form id="save_category_sortable" enctype="multipart/form-data">
                                ...
                                <div class="w-100 text-center">
                                    <button type="button" class="btn btn-default mw-120" onclick="save_category_sortable()">{{__('label.save')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        function sortableBTN() {
            ...
            for (var i = 0; i < category_data.length; i++) { 
                htmlContent += '<div id="'+ category_data[i].id +'" class="listitemClass mb-3 sortablebox">' +
                                '<p class="m-2 py-1">'+ category_data[i].name +'</p>' +
                            '</div>';
            }
