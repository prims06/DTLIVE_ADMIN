        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('admin.shorts.episode.add', ['id' => $shorts_id, 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-150" style="margin-top: -14px;">{{__('label.add_new_episode')}}</a>
                </div>
            </div>

            <div class="card custom-border-card">
                <!-- Search -->
                <form action="{{ route('admin.shorts.episode.index', ['id' => $shorts_id, 'type_id' => $type['id']]) }}" method="GET">
                                ...
                                <div class="position-relative">
                                    ...
                                    <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                        <li class="list-inline-item">
                                            <a class="edit-delete-btn" href="{{ route('admin.shorts.episode.edit', ['id' => $value->id, 'type_id' => $type['id']])}}">
                                                <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a class="edit-delete-btn" href="{{ route('admin.shorts.episode.delete', ['shorts_id' => $value->show_id, 'id' => $value->id, 'type_id' => $type['id']])}}" onclick="return confirm('{{__('label.delete_episode')}}')">
