        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('admin.tvshow.add', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-150" style="margin-top: -14px;">{{__('label.add_content')}}</a>
                </div>
            </div>

            <div class="card custom-border-card">
                <!-- Search -->
                <form action="{{ route('admin.tvshow.index', ['type_id' => $type['id']])}}" method="GET">
                            ...
                            <div class="position-relative">
                                ...
                                <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                    <li class="list-inline-item">
                                        <a class="edit-delete-btn" href="{{ route('admin.tvshow.edit', ['tvshow_id' => $value->id, 'type_id' => $type['id']]) }}">
                                            <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="edit-delete-btn" href="{{route('admin.tvshow.show', ['tvshow_id' => $value->id, 'type_id' => $type['id']]) }}" onclick="return confirm('{{__('label.delete_tvshow')}}')">
                                ...
                                <div class="row">
                                    @if($type['type'] == 5)
                                        ...
                                        <div class="col-12 mt-2 d-flex justify-content-between"> 
                                            <a href="{{ route('admin.tvshow.episode.index', ['id' => $value->id, 'type_id' => $value->type_id]) }}" class="btn btn-sm info-btn">{{__('label.episode_list')}}</a>
