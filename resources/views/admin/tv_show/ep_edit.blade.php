        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('admin.tvshow.episode.index',['id'=> $data['show_id'], 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-120" style="margin-top:-14px">{{__('label.episode_list')}}</a>
                </div>
            </div>
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_edit_tvshow_video', '{{ route("admin.tvshow.episode.index", ["id" => $data["show_id"], "type_id" => $type["id"]]) }}');
                    },
