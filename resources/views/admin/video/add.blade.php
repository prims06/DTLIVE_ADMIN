        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('admin.video.index', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-120" style="margin-top:-14px">{{__('label.content_list')}}</a>
                </div>
            </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id[]" id="category_id" multiple style="width:100%!important;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="language_id[]" id="language_id" multiple style="width:100%!important;">
