        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('admin.video.add', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-120" style="margin-top: -14px;">{{__('label.add_content')}}</a>
                </div>
            </div>
            ...
            <div class="card custom-border-card">
                ...
                <!-- Search -->
                <form action="{{ route('admin.video.index', ['type_id' => $type['id']])}}" method="GET">
                                ...
                                <div class="position-relative">
                                    ...
                                    <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                        <li class="list-inline-item">
                                            <a class="edit-delete-btn" href="{{ route('admin.video.edit', ['video_id' => $value->id, 'type_id' => $type['id']]) }}">
                                                <i class="fa-solid fa-pen-to-square fa-xl"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a class="edit-delete-btn" href="{{route('admin.video.show', ['video_id' => $value->id, 'type_id' => $type['id']]) }}" onclick="return confirm('{{__('label.delete_content')}}')">
