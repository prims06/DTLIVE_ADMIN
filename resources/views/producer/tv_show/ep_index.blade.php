        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('producer.tvshow.episode.add', ['tvshow_id' => $tvshow_id, 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-150" style="margin-top: -14px;">{{__('label.add_new_episode')}}</a>
                </div>
            </div>

            <div class="card custom-border-card">
                <!-- Search -->
                <form action="{{ route('producer.tvshow.episode.index', ['tvshow_id' => $tvshow_id, 'type_id' => $type['id']]) }}" method="GET">
                            ...
                            <div class="position-relative">
                                ...
                                <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                    <li class="list-inline-item">
                                        <a class="edit-delete-btn" href="{{ route('producer.tvshow.episode.edit', ['tvshow_id' => $value->id, 'type_id' => $type['id']])}}" title="{{__('label.edit')}}">
                                            <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="edit-delete-btn" href="{{ route('producer.tvshow.episode.delete', ['tvshow_id' => $value->show_id, 'id' => $value->id, 'type_id' => $type['id']])}}" title="{{__('label.delete')}}" onclick="return confirm('{{__('label.delete_episode')}}')">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="imageListId">
                                @foreach ($sortable_data as $key => $value)
