        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('producer.shorts.episode.index',['id'=> $data['show_id'], 'type_id' => $type['id']]) }}" class="btn btn-default-white mw-120" style="margin-top:-14px">{{__('label.episode_list')}}</a>
                </div>
            </div>
