        ...
        <div class="body-content">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('producer.shorts.add', ['type_id' => $type['id']]) }}" class="btn btn-default-white mw-150" style="margin-top: -14px;">{{__('label.add_content')}}</a>
                </div>
            </div>

            <div class="card custom-border-card">
                <!-- Search -->
                <form action="{{ route('producer.shorts.index', ['type_id' => $type['id']])}}" method="GET">
                                ...
                                <div class="position-relative">
                                    ...
                                    <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                        <li class="list-inline-item">
                                            <a class="edit-delete-btn" href="{{ route('producer.shorts.edit', ['shorts_id' => $value->id, 'type_id' => $type['id']]) }}">
                                                <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a class="edit-delete-btn" href="{{route('producer.shorts.show', ['shorts_id' => $value->id, 'type_id' => $type['id']]) }}" onclick="return confirm('{{__('label.delete_shorts')}}')">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 d-flex justify-content-between"> 
                                            ...
                                            @endif
                                            <a href="{{ route('producer.shorts.episode.index', ['id' => $value->id, 'type_id' => $value->type_id]) }}" class="btn btn-sm info-btn">{{__('label.episode_list')}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
